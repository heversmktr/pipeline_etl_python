...
conn = sqlite3.connect('C:\myprojects\pipeline_etl_python\data\quotes.db')
...
# Título da aplicação
st.title('Pesquisa de Mercado - Perfumes Masculinos no Mercado Livre')
...
unique_brands = df['new_price'].nunique()
